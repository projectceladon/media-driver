...
*/
//!
//! \file      codechal_cenc_decode_hevc.h 
//! \brief     Impelements the public interface for CodecHal CENC Decode 
//!
#ifndef __CODECHAL_CENC_DECODE_HEVC_H__
#define __CODECHAL_CENC_DECODE_HEVC_H__
...
class CodechalCencDecodeHevc : public CodechalCencDecode
{
public:
...
#endif  // __CODECHAL_CENC_DECODE_HEVC_H__
