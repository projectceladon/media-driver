...
*/
//!
//! \file      codechal_cenc_decode_avc.h 
//! \brief     Impelements the public interface for CodecHal CENC Decode 
//!
#ifndef __CODECHAL_CENC_DECODE_AVC_H__
#define __CODECHAL_CENC_DECODE_AVC_H__
...
class CodechalCencDecodeAvc : public CodechalCencDecode
{
public:
...
#endif  // __CODECHAL_CENC_DECODE_AVC_H__