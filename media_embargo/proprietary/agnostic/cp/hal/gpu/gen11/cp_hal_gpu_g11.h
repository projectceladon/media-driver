...
#ifndef __CP_HAL_GPU_G11_H__
#define __CP_HAL_GPU_G11_H__
...
#define PAVP_GEN11_FIRST_RESERVED_COUNTER_BIT   60
#define PAVP_GEN11_LAST_RESERVED_COUNTER_BIT    63

/// \class CPavpGpuHal11
/// \brief HAL layer for PAVP functions prototypes for Gen 11
class CPavpGpuHal11 : public CPavpGpuHalLegacy
{
public:

    CPavpGpuHal11(PLATFORM& sPlatform, MEDIA_WA_TABLE& sWaTable, HRESULT& hr, CPavpOsServices& OsServices);
...
private:
    ...
    virtual HRESULT BuildCryptoCopy(MOS_COMMAND_BUFFER *pCmdBuf,
