...
//!
//! \file     mhw_cp_hwcmd_g11_X.h
//! \brief    CP command defintions for all Gen11-based platforms
...
//!
#ifndef __MHW_CP_HWCMD_G11_X_H__
#define __MHW_CP_HWCMD_G11_X_H__

#include "mhw_cp.h"

namespace mhw_pavp_g11_X
{
    /*****************************************************************************\
    STRUCT: _MI_STORE_REGISTER_MEM_CMD_G11
