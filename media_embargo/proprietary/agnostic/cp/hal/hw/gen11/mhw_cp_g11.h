...
#ifndef __MHW_CP_G11_H__
#define __MHW_CP_G11_H__
...
#define MHW_PAVP_AUTHENTICATED_KERNEL_SIP_BIT_G11       (1 << 16)

class MhwCpG11 : public MhwCpBase
{
public:
    // ----- interface functions ------------------------------------------- //
    MhwCpG11(MOS_STATUS& eStatus, MOS_INTERFACE& osInterface);
    virtual ~MhwCpG11();
    ...
    static MOS_STATUS AddMfxCryptoCopyG11(
        MhwCpBase*                   mhwCp,
        PMOS_COMMAND_BUFFER          cmdBuffer,
        PMHW_PAVP_CRYPTO_COPY_PARAMS params);
...
// HW units
class CpHwUnitG11Rcs : public CpHwUnitRcs
{
   public:
    ///////////////////////////////////////////////////////////////////////////
    /// \brief       Add necessary commands and the beginning of the command buffer.
    ...
    CpHwUnitG11Rcs(MOS_STATUS& eStatus, MOS_INTERFACE& osInterface);
    ~CpHwUnitG11Rcs() override;
...
class CpHwUnitG11Vecs : public CpHwUnitVecs
{
public:
    // ----- VEBox ----------------------------------------------------------//
    ///////////////////////////////////////////////////////////////////////////
    ...
    CpHwUnitG11Vecs(MOS_STATUS& eStatus, MOS_INTERFACE& osInterface);
    virtual ~CpHwUnitG11Vecs();
...
class CpHwUnitG11Vcs : public CpHwUnitVcs
{
public:
    // ----- VDBox ----------------------------------------------------------//
    ///////////////////////////////////////////////////////////////////////////
    ...
    CpHwUnitG11Vcs(MOS_STATUS& eStatus, MOS_INTERFACE& osInterface);
    ~CpHwUnitG11Vcs() override;
...
const std::map<MOS_HW_COMMAND, DecryptBitOffset> g_decryptBitOffsets_g11{
