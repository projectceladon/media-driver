...
#ifndef __MHW_CP_G9_H__
#define __MHW_CP_G9_H__

#include <array>
#include <list>
#include "mhw_cp.h"

class MhwCpG9 : public MhwCpBase
{
public:
    // ----- interface functions ------------------------------------------- //
    MhwCpG9(MOS_STATUS& eStatus, MOS_INTERFACE& osInterface);
    virtual ~MhwCpG9();
    ...
    static MOS_STATUS AddMfxAesStateG9(
        MhwCpBase*           mhwCp,
        PMOS_INTERFACE       osInterface,
        bool                 isDecodeInUse,
        PMOS_COMMAND_BUFFER  cmdBuffer,
    ...
    ///              If fail, return other MOS errors
    ///////////////////////////////////////////////////////////////////////////////
    MOS_STATUS GetCounterValue(uint32_t* ctr);

    using CounterArray = std::array<uint32_t, CODEC_DWORDS_PER_AES_BLOCK>;
    std::list<CounterArray> m_counterList;
};

// HW units
class CpHwUnitG9Rcs : public CpHwUnitRcs
{
public:
    ///////////////////////////////////////////////////////////////////////////
    /// \brief       Add necessary commands and the beginning of the command buffer.
    ...
    CpHwUnitG9Rcs(MOS_STATUS& mos_status, MOS_INTERFACE& osInterface);
    ~CpHwUnitG9Rcs() override;
...
class CpHwUnitG9Vecs : public CpHwUnitVecs
{
public:
    ///////////////////////////////////////////////////////////////////////////
    /// \brief       Add check to exit if expected PAVP mode is not active
    ...
    CpHwUnitG9Vecs(MOS_STATUS& mos_status, MOS_INTERFACE& osInterface);
    virtual ~CpHwUnitG9Vecs();
...
class CpHwUnitG9Vcs : public CpHwUnitVcs
{
public:
    ///////////////////////////////////////////////////////////////////////////
    /// \brief       Add Pavp Crypto Inline Status Read to the command buffer.
    ...
    CpHwUnitG9Vcs(MOS_STATUS& mos_status, MOS_INTERFACE& osInterface);
    virtual ~CpHwUnitG9Vcs();
...
const std::map<MOS_HW_COMMAND, DecryptBitOffset> g_decryptBitOffsets_g9{
