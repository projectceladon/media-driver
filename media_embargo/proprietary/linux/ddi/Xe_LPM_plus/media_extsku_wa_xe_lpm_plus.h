...
*/
//!
//! \file     media_extsku_wa_xe_lpm_plus.h
//!

#ifndef __MEDIA_EXTSKU_WA_XE_LPM_PLUS_H__
#define __MEDIA_EXTSKU_WA_XE_LPM_PLUS_H__
...
#endif //__MEDIA_EXTSKU_WA_XE_LPM_PLUS_H__
