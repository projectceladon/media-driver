...
*/
//!
//! \file     media_extsku_wa_g12_adln.cpp
//!

#include "linux_skuwa_debug.h"
#include "linux_media_skuwa.h"
#include "media_extsku_wa_g12_adln.h"

bool InitAdlnMediaExtSku(struct GfxDeviceInfo   *devInfo,
...
bool InitAdlnMediaExtWa(struct GfxDeviceInfo   *devInfo,
...
static struct LinuxDeviceInit adllnExtDeviceInit =
{
    .productFamily    = IGFX_ALDERLAKE_N,
    .InitMediaFeature = InitAdlnMediaExtSku,
    .InitMediaWa      = InitAdlnMediaExtWa,
};

static bool adllpExtDeviceRegister = DeviceInfoFactory<LinuxDeviceInit>::
    RegisterDevice((uint32_t)IGFX_ALDERLAKE_N + MEDIA_EXT_FLAG, &adllnExtDeviceInit);
